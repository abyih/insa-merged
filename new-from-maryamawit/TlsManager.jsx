...
//north bound ishere, fixed some issues
...
//         const nb = Boolean(data.northbound);
...
//         setStatusMessage({
//           type: "success",
//           text: data.message || `TLS ${nextState ? "Enabled" : "Disabled"} successfully for ${channel.toUpperCase()}.`,
//         });
...
//         setStatusMessage({
//           type: "error",
//           text: errData.error || `Failed to update ${channel.toUpperCase()} TLS on ${selectedController.toUpperCase()}.`,
//         });
//         setToggling(false);
//       }
//     } catch (err) {
